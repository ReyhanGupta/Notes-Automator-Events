...
public class Binaural extends Activity {
	...
	MeditationService obj;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			mains.setText("Binaural Beats");
			mainsIV.setImageResource(R.drawable.braon);
	...
	/*	
		...
		{
			startService(new Intent(Binaural.this, BinauralService.class));

		}
		
		public void pause(View v)
		{
			stopService(new Intent(Binaural.this, BinauralService.class));
		...
		{
			Intent i= new Intent(Binaural.this,Meditation_AutomatorNew.class);
			startActivity(i);
		}
