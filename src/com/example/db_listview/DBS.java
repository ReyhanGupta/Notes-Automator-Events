...
private static final String TAG = "DBAdapter";
	...
	public Cursor retID(String s)
	{
		Cursor csr;
		csr=db.rawQuery("Select * from "+DATABASE_TABLE+"  where  "+KEY_NAME+"  LIKE '"+"%"+s+"%';",null);
		if(csr.moveToFirst())
		{
			
			String nam= csr.getString(1);
			long id=csr.getLong(0);
			String tti=csr.getString(3);
			Toast.makeText(context, nam, 1000).show();
	...
	//	obj.finish();
	//	Intent iu= new Intent(context, Search.class);
		//iu.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		//iu.putExtra(nam, "one");
		//context.startActivity(iu);
		//obj.startActivity(iu);
		//iu.putExtra(nam, "pass1");
		//iu.putExtra(tti, "pass2");
//			obj.i=id;
//			obj.note=nam;
//			obj.title=tti;
		}
		...
		{
			Toast.makeText(context, "Doesnt exist", 1000).show();
		}
		return csr;
	}
